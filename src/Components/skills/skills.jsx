...
const navBar = () =>{
    return(
      <>
      <section className='section-skills d-flex align-items-center justify-content-center flex-wrap '>
        <h2 className='titulo-skills fs-1'>SKILLS</h2>
        <section className='  d-flex justify-content-evenly align-items-center'>
            <section className='d-flex flex-wrap align-items-center justify-content-around carta  p-3 borde-cont-img'>
                <h2 className='fs-3 front mb-5'>Front-end</h2>
                <div className='d-flex flex-wrap justify-content-around cont-img '>
            ...
            <section className='d-flex flex-wrap align-items-center justify-content-around carta p-3 borde-cont-img '>
                <h2 className='fs-3 front mb-5'>Back-end</h2>
                <div className='d-flex flex-wrap justify-content-around cont-img'>
                  <img src={js} alt="" className='img-skills'/>
